...
@section('auth')
    <div class="container">
        @if( Session::has('unregistered_domain') )
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="alert alert-danger" role="alert">
                        {!! trans('text.register_domain', ['domain' => Session::get('unregistered_domain')]) !!}
                    </div>
                </div>
            </div>
        @endif
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input id="domain" type="text"
                                           class="form-control text-right @error('domain') is-invalid @enderror"
